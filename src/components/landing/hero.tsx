...
export const Hero = () => {
  return (
    <div className="flex justify-center pt-10 md:pt-20 w-full">
      <div className="flex flex-col items-center gap-2 w-fit text-center">
        ...
        <div className="flex flex-col items-center mb-1 md:mb-3">
          <h1
            className="bg-clip-text font-medium text-transparent text-4xl lg:text-5xl sm:text-left leading-none tracking-tighter"
            style={{
              backgroundImage:
          ...
          <h1
            className="bg-clip-text font-medium text-transparent text-4xl lg:text-5xl sm:text-left tracking-tighter"
            style={{
              backgroundImage:
