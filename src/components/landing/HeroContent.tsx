  ...
  return (
    <div className="space-y-4 md:space-y-6">
      <h1 className=" font-bold tracking-tight mt-3">
        <span className="block text-3xl md:text-6xl  lg:text-7xl  bg-gradient-to-r from-purple-400 to-pink-400 bg-clip-text text-transparent pb-1 md:pb-2">
          Make your website stand out
        </span>
        <span className="block text-white text-3xl md:text-6xl  lg:text-7xl">Beautiful & Unique UIs</span>
      </h1>
